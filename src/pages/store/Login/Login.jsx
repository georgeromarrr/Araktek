          ...
          <div className="bg-white p-6 rounded shadow-lg login-card">
            <div className="flex items-center justify-center mb-4 flex-col">
              ...
              <p className="text-xs leading-loose text-center cursor-default text-gray-500">
                Please login below- if you registered on our old website, please
                create a new account and we will copy all your orders across.
              </p>
            </div>
            <div className="flex flex-col">
              <span className="text-center text-sm text-red-600 mb-5">
                {login.error_wrong}
              </span>
            ...
            <input
              ...
              name="email"
              type="email"
              className="h-12 w-full py-2 bg-gray-50 text-gray-500 px-1 outline-none mb-4"
            ...
            <div className="flex justify-end">
              <p className="text-xs my-5 cursor-pointer hover:underline">
                Forgot Password?{" "}
              </p>
            </div>
            <button
              type="submit"
              className="bg-zinc-900 w-full text-gray-100 py-2 rounded"
            >
              Log In
            </button>
