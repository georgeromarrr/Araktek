        ...
        <form onSubmit={registerSubmit}>
          <div className="bg-white login-card p-6 rounded shadow-lg">
            <div className="flex items-center justify-center mb-4 flex-col">
              <p className="text-3xl font-dge_bold cursor-default">
                Create An Account
              </p>
            ...
            <div class="flex items-center">
              ...
              />
              <label class="ml-2 text-xs text-gray-900 dark:text-gray-300 py-5">
                Sign up to our newsletter & receive the latest news, offers &
                discounts
              </label>
            </div>
            <button
