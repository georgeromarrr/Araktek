  ...
  return (
    <div className="m-10 py-1">
      <div className="my-2 flex justify-between items-start">
        ...
        <button
          type="button"
          className="border border-black text-black py-2 px-6 rounded-md hover:bg-green-400 hover:text-white hover:border-green-400"
        >
          View Category List
        </button>
      </div>
      <div className="p-4 container mx-auto">
        <form className="flex flex-col gap-4 pb-4 ">
          ...
          <div className="py-3 mx-auto items-center flex justify-end gap-4 w-6/12">
            <button
              type="submit"
              className="border w-4/12 bg-gray-100 text-black border-black py-2 px-12 rounded-md hover:bg-green-400 hover:border-green-400 hover:text-white"
            >
              Submit
            </button>
          </div>
