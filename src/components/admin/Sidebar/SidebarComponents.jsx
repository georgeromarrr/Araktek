  ...
  return (
    ...
    >
      <circle
        ...
        strokeWidth="4"
      />
      <path d="M13.997 26.422v-3.094h5.38v-1.916h-5.38v-3.094h5.38v-5.293H29.42a9.736 9.736 0 0 1 6.884 2.418 7.582 7.582 0 0 1 1.96 2.875h4.204v3.093h-3.572q.02.393.021.785a9.515 9.515 0 0 1-.065 1.132h3.616v3.094h-4.422a10.796 10.796 0 0 1-1.46 2.308q-2.331 2.768-7.167 2.767h-5.707v13.528h-4.335V26.422Zm17.928-8.997a9.446 9.446 0 0 0-3.943-.675h-4.27v1.568h9.476a5.35 5.35 0 0 0-1.263-.893Zm2.614 4.793a7.214 7.214 0 0 0-.044-.806H23.712v1.916h10.762a8.959 8.959 0 0 0 .065-1.11Zm-6.557 5.62a8.191 8.191 0 0 0 4.727-1.242c.087-.058.167-.116.24-.174h-9.237v1.416Z" />
    </svg>
  );
};
