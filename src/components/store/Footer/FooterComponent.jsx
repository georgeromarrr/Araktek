...
import romarimg from "../../assets/img/team/romar.jpg";
import louieimg from "../../assets/img/team/Louie.jpg";
import johnimg from "../../assets/img/team/John.jpg";

// Logo Image
export const FooterLogo = () => {
  return <img className="h-14" src={logoimg} alt="Araktek Logo" />;
};
...
export const RightIcon = () => {
  return (
    ...
    >
      <polygon
        fill="#fff"
        points="569 3037 569 3058 548 3058 548 3056 567 3056 567 3037"
        transform="rotate(-45 -3379.948 2203.858)"
      ></polygon>
    </svg>
  );
};
      ...
      <div className="container mx-auto mt-14 pb-8 laptop:hidden tablet:hidden mobile:hidden">
        <div className="flex justify-between px-4 pt-10">
          <div className=" text-white w-6/12 mt-3">
            ...
            <p className="my-6">
              Araktek is the go-to shop for pre-built pc, accessories and
              collectible items. With a wide range of quality products. Araktek
              has you covered for providing the latest and in-demand products
              available in our store at a reasonable price tag.
            </p>
          </div>
          <div className="text-white mt-1">
            <h1 className="font-dge_bold text-3xl mt-4 mb-7">SUPPORT</h1>
            <Link to="/">
              <p className="my-2 footer-item">Return & Refund</p>
            </Link>
            <Link to="/">
              <p className="my-2 footer-item">Order Cancellation</p>
            </Link>
            <Link to="/">
              <p className="my-2 footer-item">Warranty</p>
            </Link>
            <Link to="/">
              <p className="my-2 footer-item">FAQs</p>
            </Link>
          </div>
          <div className="text-white mt-1">
            <h1 className="font-dge_bold text-3xl mt-4 mb-7">ABOUT</h1>
            <Link to="/about">
              <p className="my-2 footer-item">Company</p>
            </Link>
            <Link to="/">
              <p className="my-2 footer-item">Promos</p>
            </Link>
            <Link to="/">
              <p className="my-2 footer-item">Support</p>
            </Link>
            <Link to="/">
              <p className="my-2 footer-item">Terms & Services</p>
            </Link>
          </div>
        </div>
        ...
        <div className="flex gap gap-x-[149px] px-4 pt-5 pb-8">
          <div className=" text-white w-6/12">
            ...
            <form className="flex border p-1 w-9/12">
              <input
                type="text"
                className="newsletter w-full bg-black placeholder-slate-200"
        ...
        <div className="px-4 pt-10">
          ...
          <div className="text-white my-10 w-full">
            <div className="footer-men border-b-[1px] border-white h-13">
              ...
              >
                <p className="font-dge_bold text-3xl">SUPPORT</p>
                <span
                  className={isSupportOpen ? "origin-center rotate-180" : ""}
                >
                  <ArrIcon />
                </span>
          ...
          <div className="text-white my-10">
            <div className="border-b-[1px] border-white h-13">
              ...
              >
                <p className="font-dge_bold text-3xl">ABOUT</p>
                <span className={isAboutOpen ? "origin-center rotate-180" : ""}>
                  <ArrIcon />
                </span>
              </button>
